...
public class RHC_CameraStatePositionerEditor : Editor
{
	public override void OnInspectorGUI()
	{
		...
		// Recovering transform settings.
		EditorGUILayout.LabelField("Recovering Transform", EditorStyles.boldLabel);
		selfTarget.v3_CrawlingPosition = EditorGUILayout.Vector3Field("Recovering Position", selfTarget.v3_RecoveryPosition);
		selfTarget.v3_CrawlingRotation = EditorGUILayout.Vector3Field("Recovering Rotation", selfTarget.v3_RecoveryRotation);

		// Crouch recovering transform settings.
		EditorGUILayout.LabelField("Crouch Recovering Transform", EditorStyles.boldLabel);
		selfTarget.v3_CrawlingPosition = EditorGUILayout.Vector3Field("Crouch Recovering Position", selfTarget.v3_CrouchRecoveryPosition);
		selfTarget.v3_CrawlingRotation = EditorGUILayout.Vector3Field("Crouch Recovering Rotation", selfTarget.v3_CrouchRecoveryRotation);
		...
		if (GUILayout.Button("Recovering Transform"))
		{
			selfTarget.v3_RecoveryPosition = selfTarget.transform.localPosition;
			selfTarget.v3_RecoveryRotation = selfTarget.transform.localEulerAngles;
		}
		if (GUILayout.Button("Crouch Recovering Transform"))
		{
			selfTarget.v3_CrouchRecoveryPosition = selfTarget.transform.localPosition;
			selfTarget.v3_CrouchRecoveryRotation = selfTarget.transform.localEulerAngles;
		}
		...
		if (GUILayout.Button("Recovering Transform"))
		{
			selfTarget.transform.localPosition = selfTarget.v3_RecoveryPosition;
			selfTarget.transform.localEulerAngles = selfTarget.v3_RecoveryRotation;
		}
		if (GUILayout.Button("Crouch Recovering Transform"))
		{
			selfTarget.transform.localPosition = selfTarget.v3_CrouchRecoveryPosition;
			selfTarget.transform.localEulerAngles = selfTarget.v3_CrouchRecoveryRotation;
		}
